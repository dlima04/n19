...
TEST_CASE(StringUtil, RegularStringUnescape) {
...
TEST_CASE(StringUtil, QuotedStringUnescape) {
  SECTION(BasicQuoted, {
...
TEST_CASE(StringUtil, RawStringUnescape) {
  SECTION(BasicRaw, {
...
TEST_CASE(StringUtil, RawQuotedStringUnescape) {
